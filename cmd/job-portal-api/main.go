...
func startApp() error {
	...
	privatePEM, err := os.ReadFile(`C:\Users\ORR Training 7\Documents\job-portal-api\private.pem`)
	if err != nil {
	...
	publicPEM, err := os.ReadFile(`C:\Users\ORR Training 7\Documents\job-portal-api\pubkey.pem`)
	if err != nil {
